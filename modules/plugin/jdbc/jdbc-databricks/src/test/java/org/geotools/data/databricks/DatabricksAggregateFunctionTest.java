...
/**
 * Test for aggregate functions in Databricks SQL
 *
 * @author Stuart Lynn
 */
public class DatabricksAggregateFunctionTest extends JDBCAggregateFunctionOnlineTest {

    @Override
    protected JDBCAggregateTestSetup createTestSetup() {
        return new DatabricksAggregateFunctionTestSetup();
    }
}
